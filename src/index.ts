...
yargs(hideBin(process.argv))
  ...
  .command('campaigns:create', 'Create a campaign', (y: Argv) =>
    dataOption(y)
      ...
      .option('sourcing-id', { describe: 'Pattern A: link existing standalone sourcing as trigger', type: 'string' })
      .option('search-criteria', { describe: 'Pattern B: create embedded sourcing with search criteria (JSON)', type: 'string' })
      .option('sourcing-limit', { describe: 'Pattern B: max prospects to source (used with --search-criteria)', type: 'number' })
